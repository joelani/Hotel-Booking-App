...
const AllRooms = () => {
    ...
    //Function to sort rooms based on the s3lected sort option 
    const sortRooms = (a, b) =>{
    ...
    // Filter and sort rooms based on the sselected filters and sort option 
    const filteredRooms = useMemo(()=>{
        return rooms.filter(room => matchesRoomType(room) && matchesPriceRanges(room) && filterDestination(room)).sort(sortRooms);
...
// Clear All Filters 
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between gap-3 pt-28 md:pt-35 px-4 md:px-16 lg:px-16 xl:px-24'>
      <div className=' w-3/4'>
        <div className='flex flex-col items-start text-left'>
            ...
            {filteredRooms.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0 '>
                    ...
                    src={room.images[0]} alt="hotel-img" title='View Room Details' className='max-h-67 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer' />
                    <div className='flex flex-col md:w-1/2 gap-2'>
                        ...
                        <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                            {room.amenities.map((item, index)=>(
                                <div key={index} className='flex items-center px-3 py-2 gap-2 rounded-lg bg-[#f5f5ff]/70'>
