        ...
        const mailOptions = {
            ...
            html: `
                ...
                <ul>
                    ...
                    <li><strong>Hotel Name:</strong> ${roomData.hotel?.name || 'N/A'}</li>
                ...
                <p>If you need to make any changes , feel free to message us.</p>
            `
        }
                ...
                // You can still allow booking to go through
            }
